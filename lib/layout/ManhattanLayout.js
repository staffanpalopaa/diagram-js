 ...
 * @return {Array<Point>}
 */
function getBendpoints(a, b, directions, source) {
 ...
 * @return {Array<Point>}
 */
export function connectPoints(a, b, directions, source) {

  var points = getBendpoints(a, b, directions, source);
...
export function connectRectangles(source, target, start, end, hints) {
  ...
  return connectPoints(startDocking, endDocking, directions, source);
}
